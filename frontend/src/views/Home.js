	...
	if (!delayed) {
		...
		return (
			<>
				...
				>
					<div className="row d-flex justify-content-center d-flex align-items-center">
						<div className="col-lg-6 col-md-12" style={{ textAlign: "right" }}>
							<h1 data-aos="slide-right" onMouseOver={onMouse} onMouseOut={onMouseOutOver} style={{ whiteSpace: "pre" }}>
								Hi! I am Diky Ardiyanto
							</h1>
							<div className="wrapper">
								<h2 style={{ fontFamily: "Montserrat" }} data-aos="slide-right">
									A <span></span> Developer
								</h2>
							</div>
							<h2 data-aos="slide-right" style={{ fontFamily: "Montserrat" }} className="textHovering">
								Based in Indonesia
							</h2>
							<p data-aos="slide-right" style={{ fontFamily: "Montserrat", fontSize: "17px" }} className="textHovering">
				...
				<div
					className="container-fluid section-page"
					style={{ backgroundColor: "#B6EADA", minHeight: "80vh", paddingTop: "5%", display: "flex", flexWrap: "nowrap", padding: "50px" }}
				>
					<div className="row d-flex justify-content-center d-flex align-items-center">
						<div className="col-lg-6 col-md-12" style={{ textAlign: "justify", paddingRight: "20px", color: "#03001C" }}>
							<h2 data-aos="slide-right" style={{ fontFamily: "Montserrat", fontWeight: "bold", fontSize: "25px" }} className="textHovering2">
							...
							<h4 data-aos="slide-right" style={{ fontFamily: "Montserrat" }} className="textHovering3">
								- Martin Luther King, Jr.
							</h4>
						</div>
						<div className="col-lg-6 col-md-12" style={{ textAlign: "justify", color: "#03001C", overflow: "hidden" }}>
							<h3 data-aos="slide-left" style={{ textAlign: "justify", lineHeight: "1.5" }} className="textHovering4">
								I am a Full Stack Developer. I am particularly interested in developing applications that are both beautiful and functional.
							</h3>
							<h3 data-aos="slide-left" style={{ textAlign: "justify", lineHeight: "1.5" }} className="textHovering4">
								...
								cutting-edge frameworks such as Vue and React, and I have a passion for creating intuitive and engaging mobile applications using
								React Native. I am always looking to expand my skill set and have recently taken a keen interest in Python programming. In my free
								time, I am also indulging my love of languages and am currently studying Japanese to deepen my understanding of this rich and
								fascinating culture.
							</h3>
						</div>
					</div>
				...
				<div
					className="custom-shape-divider-top-1676192244 display-divider"
