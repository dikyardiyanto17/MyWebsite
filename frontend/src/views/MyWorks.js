	...
	if (!delayed) {
		...
		return (
			<>
					...
					<div style={{ margin: "auto", textAlign: "Center", marginTop: "50px" }}>
						...
						<div className="d-flex col" style={{ textAlign: "left" }}>
							...
							<div className="col-9" style={{ textAlign: "left", marginLeft: "0px" }}>
								<img data-aos="zoom-in-up" id="tynkerlogo" src={Telepati} style={{ height: "10vw" }} alt="" />
							</div>
						</div>
						<div className="d-flex col" style={{ textAlign: "left" }}>
							<div className="col-3" style={{ marginLeft: "0px" }}>
							...
							<div className="col-9" style={{ textAlign: "left" }}>
								<div data-aos="zoom-in-up">
									<img className="tynkerscreenshot" src={T1} style={{ width: "15vw", margin: "10px" }} alt="" />
									<img className="tynkerscreenshot" src={T2} style={{ width: "15vw", margin: "10px" }} alt="" />
									<img className="tynkerscreenshot" src={T3} style={{ width: "15vw", margin: "10px" }} alt="" />
									<img className="tynkerscreenshot" src={T4} style={{ width: "15vw", margin: "10px" }} alt="" />
									<img className="tynkerscreenshot" src={T5} style={{ width: "15vw", margin: "10px" }} alt="" />
									<img className="tynkerscreenshot" src={T6} style={{ width: "15vw", margin: "10px" }} alt="" />
								</div>
							</div>
						</div>
						<div className="d-flex col" style={{ textAlign: "left" }}>
							...
							<div className="col-9" style={{ textAlign: "left" }}>
								<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap" }}>
									<p className="descriptiontext" data-aos="zoom-in-up">
										Telepati offers free conference meetings using a VPS server with one core. It provides free conference meetings with a Google
										login option. When you join the room, you will be redirected to the lobby and can choose to join the room using a Google account
										or not. The first user who joins the room will become the admin, with the ability to mute all participants in the room. It
										includes features such as turning on/off the camera, switching cameras, muting the microphone, muting all participants for the
										admin, chat functionality, screen sharing, copying the room URL, and recording.
									</p>
								</div>
							</div>
						</div>
						<div className="d-flex col" style={{ textAlign: "left" }}>
							...
							<div className="col-9" style={{ textAlign: "left", overflow: "hidden" }}>
								<p className="descriptiontext" data-aos="zoom-in-up">
									NodeJS, Express, GoogleAuth, Socket.IO, Bootstrap, Mediasoup
								</p>
							</div>
						</div>
						<div className="d-flex col" style={{ textAlign: "left" }}>
							...
							<div className="col-9" style={{ textAlign: "left", overflow: "hidden" }}>
								<iframe data-aos="zoom-in-up" src="https://meet.dikyardiyanto.site" style={{ width: "65vw", height: "80vh" }} title="glek" />
							</div>
						</div>
						<div className="d-flex col" style={{ textAlign: "left" }}>
							<div className="col-3" style={{ marginLeft: "0px" }}>
							...
							<div className="col-9" style={{ textAlign: "left" }}>
								<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap" }}>
									<a
										...
										href="https://meet.dikyardiyanto.site"
										target="_blank"
									>
										Click For Demo
									</a>
				...
				<div
					className="custom-shape-divider-top-1676192244"
					style={{ position: "relative", margin: "0", backgroundColor: "#03001C", zIndex: "-1" }}
					id="movinganimation"
				>
							...
							<div className="col-9" style={{ textAlign: "left" }}>
								<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap" }}>
									<p className="descriptiontext" data-aos="zoom-in-up">
										...
										features that the app might include are counting games that help children learn to count numbers, object recognition exercises
										that help children identify and name different objects, and English language activities that teach basic vocabulary and sentence
										structure.
									</p>
									<p className="descriptiontext" data-aos="zoom-in-up">
				...
				<div
					className="custom-shape-divider-top-1676191786"
					...
					<div className="d-flex col" style={{ textAlign: "left" }}>
						...
						<div className="col-9" style={{ textAlign: "left" }}>
							<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap", overflow: "hidden" }}>
								<p className="descriptiontext" data-aos="zoom-in-up">
									Niix Branded Things is a web application that allows Admin users to add, update, and delete product information in a Content
									Management System (CMS). Customers can only view the product information. The web app is built using JavaScript, ReactJS, and
									NodeJS.
								</p>
								<p className="descriptiontext" data-aos="zoom-in-up">
									I was solely responsible for this project as a Full Stack Developer. From building the backend to creating the frontend, I handled
									it all. It was an exciting opportunity for me to showcase my skills and deliver a complete solution for the project.
								</p>
							</div>
						</div>
					</div>
						...
						<div className="col-9" style={{ textAlign: "left" }}>
							<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap" }}>
								<a
									...
									data-aos="zoom-in-up"
									style={{ textDecoration: "none", color: "#03001C" }}
									href="https://github.com/dikyardiyanto17/niixbrandedthings"
									target="_blank"
								>
									Github
								</a>
					...
					<div style={{ margin: "auto", textAlign: "Center", marginTop: "50px" }}>
						...
						<div className="d-flex col" style={{ textAlign: "left" }}>
							...
							<div className="col-9" style={{ textAlign: "left" }}>
								<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap" }}>
									<p className="descriptiontext" data-aos="zoom-in-up">
										Yugioh Card Selector is a website that helps you build your own custom deck for the Yugioh card game. You can also search for
										cards based on your preferences and add them to your collection. It's an easy-to-use tool for all Yugioh players, whether you're
				...
				<div style={{ backgroundColor: "#B6EADA", paddingTop: "5%", color: "#03001C", padding: "10px" }}>
					...
					<div className="d-flex col" style={{ textAlign: "left" }}>
						...
						<div className="col-9" style={{ textAlign: "left" }}>
							<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap", overflow: "hidden" }}>
								<p className="descriptiontext" data-aos="zoom-in-up">
									GitSearch is a user-friendly web application that allows you to search for GitHub users and their repositories with ease. The app is
									built using TypeScript and React, providing a seamless and interactive experience. With GitSearch, you can quickly find the GitHub
									user you're looking for by simply typing in their username. You'll be presented with a profile of the user and their repositories.
								</p>
								<p className="descriptiontext" data-aos="zoom-in-up">
					...
					<div style={{ margin: "auto", textAlign: "Center", marginTop: "50px" }}>
						...
						<div className="d-flex col" style={{ textAlign: "left" }}>
							...
							<div className="col-9" style={{ textAlign: "left" }}>
								<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap" }}>
									<p className="descriptiontext" data-aos="zoom-in-up">
										PokeSearch is a website that contains a comprehensive list of all the Pokemon, along with their details. You can browse through
										the list to find the Pokemon you're interested in and learn more about them.
									</p>
									<p className="descriptiontext" data-aos="zoom-in-up">
										I was solely responsible for this project as a Frontend Developer.
									</p>
				...
				<div style={{ backgroundColor: "#B6EADA", paddingTop: "5%", color: "#03001C", padding: "10px" }}>
					...
					<div className="d-flex col" style={{ textAlign: "left" }}>
						...
						<div className="col-9" style={{ textAlign: "left" }}>
							<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap", overflow: "hidden" }}>
								<p className="descriptiontext" data-aos="zoom-in-up">
									Gabut is a web application where you can create an account, log in, and post using hashtags. It's a great way to connect with others
						...
						<div className="col-9" style={{ textAlign: "left" }}>
							<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap" }}>
								<a
									...
									data-aos="zoom-in-up"
									style={{ textDecoration: "none", color: "#03001C" }}
									href="https://github.com/dikyardiyanto17/pairproject"
									target="_blank"
								>
									Github
								</a>
					...
					<div style={{ margin: "auto", textAlign: "Center", marginTop: "50px" }}>
						...
						<div className="d-flex col" style={{ textAlign: "left" }}>
							...
							<div className="col-9" style={{ textAlign: "left" }}>
								<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap" }}>
									<p className="descriptiontext" data-aos="zoom-in-up">
										BlogPost is a website where users can create an account and post their own blog entries. They can also read and comment on other
										users' posts. It's a platform for people to share their thoughts, ideas, and experiences with others in a community-driven
										setting.
									</p>
									<p className="descriptiontext" data-aos="zoom-in-up">
										I was solely responsible for this project as a Full Stack Developer. From building the backend to creating the frontend, I handled
							...
							<div className="col-9" style={{ textAlign: "left" }}>
								<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap" }}>
									<a
										...
										data-aos="zoom-in-up"
										style={{ textDecoration: "none", color: "#B6EADA" }}
										href="https://github.com/dikyardiyanto17/PHP-Project"
										target="_blank"
									>
										Github
									</a>
				...
				<div style={{ backgroundColor: "#B6EADA", paddingTop: "5%", color: "#03001C", padding: "10px" }}>
					...
					<div className="d-flex col" style={{ textAlign: "left" }}>
						...
						<div className="col-9" style={{ textAlign: "left" }}>
							<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap", overflow: "hidden" }}>
								<p className="descriptiontext" data-aos="zoom-in-up">
									Glek is a simple web app that tracks your daily water intake. You can easily input your name and the amount of water you drank
									today. By clicking the 'log' button, the app will increase the bar and display a log of when you drank water. If you've already
									reached the goal of drinking 8 glasses of water, Glek will surprise you with random fun facts about water before finishing the app.
								</p>
								<p className="descriptiontext" data-aos="zoom-in-up">
									This project was a collaboration among six team members when we were still learning about JavaScript. My role in this project was as
									a Backend Engineer. Ah, those good old times!
								</p>
							</div>
						</div>
					</div>
						...
						<div className="col-9" style={{ textAlign: "left" }}>
							<div style={{ display: "flex", justifyContent: "flex-start", flexWrap: "wrap" }}>
								<a
									...
									data-aos="zoom-in-up"
									style={{ textDecoration: "none", color: "#03001C" }}
									href="https://github.com/whooptywoo/hackaton8"
									target="_blank"
								>
									Github
								</a>
